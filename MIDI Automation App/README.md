...
```swift
manager.playback { event in
    // send the event via your MIDI sender
}
```

### 3. SwiftUI Automation Panel

Use `AutomationView` to interactively control CC values, program changes, and toggle recording.

---

## Roadmap

- 🎛 Capture full MIDI messages live from hardware
- 🎚 Advanced automation: multiple channels, layered tracks
- 🔄 Sequencing and looping
- 📱 Integrate MIDI automation with SwiftUI or macOS app workflows
